...
sr.reveal('.home___data, .about__img, .about__data, .visit__data')
sr.reveal('.home___image, .footer__img-1, .footer__img-2', {rotate: {z: -15} })
sr.reveal('.home___bread, .about__bread', {rotate: {z: 15} })
sr.reveal('.home___footer', {scale: 1, origin: 'bottom'})
